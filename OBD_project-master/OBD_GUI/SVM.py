...
def svm_test(data):
    ...
    model = svm.SVC(kernel='poly', C=2, gamma=2,degree = 3,coef0=1, probability=True, class_weight='balanced')
    ...
    model = svm.SVC(kernel='rbf', C= 3, gamma=4, degree=3, coef0=0.0, shrinking=True, max_iter=-1, probability=True, class_weight='balanced')
